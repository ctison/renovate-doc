...
const options = require('../renovate/dist/config/definitions').getOptions();
let { getCliName } = require('../renovate/dist/config/cli');
let { getEnvName } = require('../renovate/dist/config/env');
